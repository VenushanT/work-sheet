(function () {
  ...
  const TRACE_GUIDES = {
    1: {
      ...
      hint: 'Start at the dot and draw straight down to the star.',
      paths: ['M50 16 L50 86']
    },
    2: {
      start: { x: 40, y: 22 },
      end: { x: 66, y: 80 },
      hint: 'Start at the dot, curve around, then slide down and finish with a short line.',
      paths: ['M40 22 C52 10 75 14 70 35 C66 50 52 60 42 72 L35 80 L66 80']
    },
    3: {
      start: { x: 60, y: 25 },
      end: { x: 40, y: 79 },
      hint: 'Start at the dot, make the top curve, then the bottom curve to the star.',
      paths: ['M60 25 C56 14 40 14 38 28 C36 40 47 45 56 48 C65 52 68 62 60 71 C54 78 47 80 40 79']
    },
    4: {
      start: { x: 39, y: 21 },
      end: { x: 66, y: 86 },
      hint: 'Start at the dot, draw down and across, then go down to the star.',
      paths: ['M39 21 L39 58 L66 58', 'M66 21 L66 86']
    },
    5: {
      start: { x: 62, y: 21 },
      end: { x: 42, y: 84 },
      hint: 'Start at the dot, go across, down, and curve around to the star.',
      paths: ['M62 21 L40 21 L40 49 C48 42 60 44 64 54 C68 68 60 84 42 84']
    },
    6: {
      start: { x: 60, y: 22 },
      end: { x: 57, y: 84 },
      hint: 'Start at the dot, curve around, and close the loop at the star.',
      paths: ['M60 22 C46 20 36 34 38 52 C40 74 58 88 68 74 C74 64 66 52 54 56 C46 58 44 72 57 84']
    },
    7: {
      start: { x: 35, y: 22 },
      end: { x: 62, y: 84 },
      hint: 'Start at the dot, draw the top line, then slant down to the star.',
      paths: ['M35 22 L70 22 L62 84']
    },
    8: {
      start: { x: 52, y: 20 },
      end: { x: 52, y: 84 },
      hint: 'Start at the dot, make the top loop, then the bottom loop to the star.',
      paths: ['M52 20 C40 20 36 36 48 42 C60 48 68 36 60 24 C58 20 54 20 52 20', 'M48 46 C34 50 34 72 52 84 C68 74 70 54 56 48 C52 46 50 46 48 46']
    },
    9: {
      start: { x: 59, y: 36 },
      end: { x: 49, y: 84 },
      hint: 'Start at the dot, make a loop, then draw down to the star.',
      paths: ['M59 36 C58 20 44 14 34 28 C26 40 30 56 44 60 C56 62 64 52 60 40', 'M60 36 L49 84']
    },
    10: {
      start: { x: 35, y: 16 },
      end: { x: 35, y: 84 },
      hint: 'Start at the dot, trace 1 first, then trace 0 and finish at the star.',
      paths: ['M35 16 L35 84', 'M72 84 C84 74 84 28 72 18 C56 8 42 24 44 50 C46 76 60 90 72 84']
    }
  };
  ...
  function getTraceGuide(traceNumber) {
    return TRACE_GUIDES[traceNumber] || {
      ...
      hint: 'Start at the dot and trace to the star.',
      paths: ['M40 18 L62 84']
    };
  }
